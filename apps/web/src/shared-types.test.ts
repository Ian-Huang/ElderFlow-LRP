...
import { ResidentCreateSchema, CareRecordCreateSchema, MedicationCreateSchema, CarePlanCreateSchema } from '@lrp/shared';
  ...
  describe('ResidentCreateSchema', () => {
    ...
    it('rejects invalid date format', () => {
      const invalidInput = {
        name: '王大明',
        gender: 'Male' as const,
        dateOfBirth: '15-03-1945', // Wrong format
        address: '台北市大安區仁愛路四段 123 號',
        insuranceId: 'A123456789',
        admissionDate: '2023-06-01',
      };
  ...
  describe('MedicationCreateSchema', () => {
    ...
    it('rejects invalid time format in schedule', () => {
      const invalidInput = {
        ...
        dosage: '10mg',
        frequency: 'OnceDaily' as const,
        schedule: ['8:00'], // Missing leading zero
        stockLevel: 30,
        reorderThreshold: 15,
      };
